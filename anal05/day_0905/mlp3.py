...
# 분류 모델 생성
# model = LGBMClassifier(n_estimators = 500, random_state=42, verbose = 2)    
from sklearn.neural_network import MLPClassifier
model = MLPClassifier(hidden_layer_sizes=30, solver = 'adam', learning_rate_init=0.01, max_iter=1000, verbose = 1)
# 이 lbfgs는 디폴트값이야
