...
image_path = 'C:/Users/acorn/OneDrive/Desktop/Artificial Intelligence/AI/day_0929/yoloex/image3_2.jpg'
...
output_path = f'C:/Users/acorn/OneDrive/Desktop/Artificial Intelligence/AI/day_0929/yoloex/yotest4_{timestamp}.jpg'
...
# 감지 결과 로그 파일로 저장
log_file = 'C:/Users/acorn/OneDrive/Desktop/Artificial Intelligence/AI/day_0929/yoloex/yotest4_log.txt'
with open(log_file, 'a', encoding = 'utf-8') as log:
    log.write(f"[{timestamp}] 감지된 객체 : {', '.join(set(detected_obj))}\n")
    log.write(description_text + '\n\n')

print(f'{log_file}에 저장됨!!!')