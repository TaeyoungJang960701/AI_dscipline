...
x = np.array([257,270,294,320,342,360,396,446,480,500])[:,np.newaxis] # 2차원
# print(x.shape) # (10, 1)
...
# 다항(다변량)회귀모델 훈련
pr.fit(x_quad, y)
x_fit_quad = polyf.fit_transform(x_fit)  # fit_transform -> transform
...
# MSE : 선형:269.808, 다항:70.406
# 설명력 : 선형:0.919, 다항:0.979